...
| cos-particle-restrict | §3.9.6 | M9+ | wip (per-name occurrence/type bag check for flat all/sequence element models; wildcard-subset, choice, and open-content subsumption deferred) | parser/restrict.go |
