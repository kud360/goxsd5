...
| cvc-identity-constraint | §3.11.4 | V3 | wip (unique/key/keyref over the selector/field subset; local-name name tests; value-space field comparison; cross-scope keyref — refer target on another/ancestor element — via document-scoped key tables flushed post-walk) | xsdvalidate/idc.go |
