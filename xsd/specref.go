...
var (
	...
	SpecSrcRedefine       = ref(1, "src-redefine", "4.2.4", "src-redefine")
	SpecSrcOverride       = ref(1, "src-override", "4.2.5", "src-override")
...
var (
	...
	SpecMaxScaleValid         = ref(2, "cvc-maxScale-valid", "pd-4.2", "cvc-maxScale-valid")
	SpecMinScaleValid         = ref(2, "cvc-minScale-valid", "pd-4.3", "cvc-minScale-valid")
...
var (
	...
	SpecMaxScaleValidRestriction       = ref(2, "maxScale-valid-restriction", "pd-4.2", "maxScale-valid-restriction")
	SpecMinScaleValidRestriction       = ref(2, "minScale-valid-restriction", "pd-4.3", "minScale-valid-restriction")
	SpecMinScaleTotalDigits            = ref(2, "minScale-totalDigits", "pd-4.3", "minScale-totalDigits")
